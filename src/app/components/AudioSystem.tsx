    ...
    useEffect(() => {
        if (videoRef.current && !hasCreatedSource.current) {
            ...
            try {
                ...
                const positions = [
                    { x: 9.4, y: 1.3, z: 0, pan: -1 },     // Left Front speaker
                    { x: -1, y: 1.3, z: 0, pan: 1 },      // Right Front speaker
                    { x: 4.2, y: 0, z: 2.3, pan: 0 },     // Center speaker
                    { x: 9.4, y: 4.1, z: 0, pan: -9.2 },  // Left Rear speaker
                    { x: -1, y: 4.1, z: 0, pan: -9.2 },     // Right Rear speaker
                ];
